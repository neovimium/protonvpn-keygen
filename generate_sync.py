...
def generate_keys():
    ...
    ed25519_public = get_public_key(ed25519_private)
    ...
    x25519_private_b64 = ed25519_to_x25519(ed25519_private_b64)
...
def main():
    keys = generate_keys()
    print("Ed25519 Private:", keys['ed25519_private'])
    print("Ed25519 Public: ", keys['ed25519_public'])
    print("X25519 Private: ", keys['x25519_private'])
